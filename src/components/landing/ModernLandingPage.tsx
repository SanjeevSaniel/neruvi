...
export default function ModernLandingPage() {
  ...
  return (
    <div ref={containerRef} className="min-h-screen bg-white overflow-hidden relative">
      ...
      {/* Hero Section */}
      <section ref={heroRef} className="relative z-10 px-6 lg:px-12 pt-16 pb-24">
        <div className="max-w-5xl mx-auto text-center">
          ...
          <div className="hero-subtitle mb-12">
            <p className="text-xl md:text-2xl text-slate-600 max-w-3xl mx-auto leading-relaxed">
              ...
              <span className="font-semibold text-blue-600">advanced RAG technology</span>,{" "}
              <span className="font-semibold text-purple-600">real-time streaming</span>, and{" "}
              <span className="font-semibold text-indigo-600">intelligent course navigation</span>.
            </p>
          </div>
          ...
          {/* Stats */}
          <div className="stats-section grid grid-cols-2 md:grid-cols-4 gap-6 max-w-3xl mx-auto">
            {stats.map((stat, index) => (
              <div key={stat.label} className="stat-card bg-white/60 backdrop-blur-sm rounded-2xl p-6 border border-white/50 shadow-lg">
      ...
      {/* Features Section */}
      <section ref={featuresRef} className="relative z-10 px-6 lg:px-12 py-24 bg-gradient-to-b from-white to-slate-50">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-slate-600 max-w-2xl mx-auto">
              Experience next-generation learning with cutting-edge technology and intelligent features
            </p>
          </div>
      ...
      {/* CTA Section */}
      <section ref={ctaRef} className="relative z-10 px-6 lg:px-12 py-24 bg-gradient-to-br from-slate-50 to-blue-50">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-xl text-slate-600 mb-12 max-w-2xl mx-auto">
            Join developers mastering programming with AI-powered precision and intelligent course navigation
          </p>
          ...
          <div className="flex justify-center items-center space-x-6 text-slate-400">
            ...
            <div className="flex items-center space-x-1">
              ...
              <span className="text-sm font-medium text-slate-600">Free to Start</span>
            </div>
            <div className="w-1 h-1 bg-slate-300 rounded-full" />
            <div className="flex items-center space-x-1">
        ...
        <div className="max-w-6xl mx-auto">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <div className="flex items-center space-x-3 mb-6 md:mb-0">
              ...
              <span className="text-slate-600">© 2025 FlowMind. All rights reserved.</span>
            </div>
